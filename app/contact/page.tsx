...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Johan Beker for collaboration, project inquiries, or any questions about services offered.",
};
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-xl flex flex-col items-center text-center">
              ...
              <span className="text-primary font-medium">Berlin, Germany</span>
            </div>
              ...
              <div className="bg-primary relative h-full min-h-[400px] lg:min-h-0 hidden lg:block">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-12">
                  ...
                  <p className="text-center opacity-90 mb-8">
                    ...
                    collaborations, and consulting. Whether you have a specific
